...
public class Thief extends Job {
     ...
     * tabla de bonus clásica para el Thief.
     */
    private static final Map<Integer, StatBlock> JOB_BONUS_SCHEDULE = Map.ofEntries(
            // STR Bonuses
            Map.entry(6,  new StatBlock(1, 0, 0, 0, 0, 0)),
            Map.entry(30, new StatBlock(1, 0, 0, 0, 0, 0)),
            Map.entry(38, new StatBlock(1, 0, 0, 0, 0, 0)),
            Map.entry(47, new StatBlock(1, 0, 0, 0, 0, 0)),

            // AGI Bonuses
            Map.entry(2,  new StatBlock(0, 1, 0, 0, 0, 0)),
            Map.entry(33, new StatBlock(0, 1, 0, 0, 0, 0)),
            Map.entry(36, new StatBlock(0, 1, 0, 0, 0, 0)),
            Map.entry(50, new StatBlock(0, 1, 0, 0, 0, 0)),

            // VIT Bonuses
            Map.entry(14, new StatBlock(0, 0, 1, 0, 0, 0)),
            Map.entry(44, new StatBlock(0, 0, 1, 0, 0, 0)),

            // INT Bonus
            Map.entry(18, new StatBlock(0, 0, 0, 1, 0, 0)),

            // DEX Bonuses
            Map.entry(10, new StatBlock(0, 0, 0, 0, 1, 0)),
            Map.entry(22, new StatBlock(0, 0, 0, 0, 1, 0)),
            Map.entry(42, new StatBlock(0, 0, 0, 0, 1, 0)),
            Map.entry(49, new StatBlock(0, 0, 0, 0, 1, 0)),

            // LUK Bonuses
            Map.entry(26, new StatBlock(0, 0, 0, 0, 0, 1)),
            Map.entry(40, new StatBlock(0, 0, 0, 0, 0, 1)),
            Map.entry(46, new StatBlock(0, 0, 0, 0, 0, 1))
    );
