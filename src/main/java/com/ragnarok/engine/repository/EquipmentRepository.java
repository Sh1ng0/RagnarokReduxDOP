...
public final class EquipmentRepository {
    ...
    static {
        ...
        // Armor
        var cottonShirt = new ArmorItem(1001L, "Cotton Shirt", Element.NEUTRAL, ArmorType.ARMOR, EquipmentBonuses.ZERO.withDefense(2), 1, Collections.emptyList(), 1);
        var basicShield = new ArmorItem(1002L, "Shield", Element.NEUTRAL, ArmorType.SHIELD, EquipmentBonuses.ZERO.withDefense(1), 1, List.of("SWORDMAN"), 1);

        // Weapons
        var knife = new WeaponItem(2001L, "Knife", Element.NEUTRAL, WeaponType.DAGGER, EquipmentBonuses.ZERO.withAttack(10), 1, Collections.emptyList(), 2, EquipmentDefaults.STANDARD_DAGGER_COMPATIBILITY);
        var basicSword = new WeaponItem(2002L, "Sword", Element.NEUTRAL, WeaponType.ONE_HANDED_SWORD, EquipmentBonuses.ZERO, 1, List.of("SWORDMAN"), 1, EquipmentDefaults.STANDARD_1H_SWORD_COMPATIBILITY);
        var twoHandedSword = new WeaponItem(2003L, "Two-Handed Sword", Element.NEUTRAL, WeaponType.TWO_HANDED_SWORD, EquipmentBonuses.ZERO, 25, List.of("SWORDMAN"), 2);
        var highLevelSword = new WeaponItem(2004L, "Blade of the Heavens", Element.HOLY, WeaponType.ONE_HANDED_SWORD, EquipmentBonuses.ZERO, 99, List.of("SWORDMAN"), 0);
        var assassinKatar = new WeaponItem(2005L, "Katar of the Shadows", Element.POISON, WeaponType.KATAR, EquipmentBonuses.ZERO, 40, List.of("ASSASSIN"), 2);
        var incompatibleAxe = new WeaponItem(2006L, "Battle Axe", Element.EARTH, WeaponType.ONE_HANDED_AXE, EquipmentBonuses.ZERO, 10, List.of("SWORDMAN"), 1, EquipmentDefaults.NON_COMPATIBLE);
